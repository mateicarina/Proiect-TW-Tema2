...
// getProjects(projectRoute).then((res) => {
//     res.forEach(element => {
//         console.log(element.projectName)
//         assignedProjects.push(createData(element.projectName));
//     });
// });

// // getProjects(projectRoute).then((el) => console.log(el));
// console.log(ap);
// ap.forEach(function (a) { assignedProjects.push(createData(a.projectName)) });
    ...
    render() {
        return (
            <div>
                ...
                <Button className="btnLogout" variant="primary"><LogoutOutlined onClick={() => { this.LogOut() }} /></Button>
            </div>
        )
    }
}
